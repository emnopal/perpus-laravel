                                ...
                                <div class="form-group{{ $errors->has('kode_transaksi') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        <input id="kode_transaksi" type="text" class="form-control"
                                               name="kode_transaksi" value="{{ $kode }}" required readonly="">
                                ...
                                <div class="form-group{{ $errors->has('tgl_pinjam') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-3">
                                        <input id="tgl_pinjam" type="date" class="form-control" name="tgl_pinjam"
                                               ...
                                               required @if(Auth::user()->role == 'member') readonly @endif>
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            <input id="buku_judul" type="text" class="form-control" readonly=""
                                                   required>
                                            <input id="buku_id" type="hidden" name="buku_id"
                                                   value="{{ old('buku_id') }}" required readonly="">
                    ...
                    <table id="lookup" class="table table-bordered table-hover table-striped">
                        ...
                        @foreach($buku as $data)
                            <tr class="pilih" data-buku_id="<?php echo $data->id; ?>"
                                ...
                                <td>@if(!isset($data->cover)||!$data->cover)
                                ...
                                <td class="py-1">
                                    @if(!isset($data->user->avatar)||!$data->user->avatar)
                                        <img src="{{url('images/user/default.png')}}" alt="image"
                                             style="margin-right: 10px;"/>
                                    @else
                                        <img src="{{url('images/user/' . $data->user->avatar)}}" alt="image"
                                             style="margin-right: 10px;"/>
                                    @endif
                                    {{$data->nama}}
                                </td>
