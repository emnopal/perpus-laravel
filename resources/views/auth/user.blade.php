                            ...
                            @foreach($data as $content)
                                <tr>
                                    <td class="py-1">
                                        ...
                                        @else
                                            <img src="{{url('images/user', $content->avatar)}}" alt="image"
                                                 style="margin-right: 10px;"/>
                                        @endif
                                        {{$content->name}}
                                    </td>
                                    <td>
                                        <a href="{{route('user.show', $content->id)}}">
                                            {{$content->username}}
                                        </a>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="btn-group dropdown">
                                            ...
                                            <div class="dropdown-menu" x-placement="bottom-start"
                                                ...
                                                <a class="dropdown-item" href="{{route('user.edit', $content->id)}}">
                                                    Edit </a>
                                                <form action="{{ route('user.destroy', $content->id) }}"
                                                      class="pull-left"
                                                      method="post">
                                                    {{ csrf_field() }}
                                                    {{ method_field('delete') }}
