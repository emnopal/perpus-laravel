...
@section('content')
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
            <form action="{{ url('/import/buku') }}" method="post" class="form-inline" enctype="multipart/form-data">
                {{ csrf_field() }}
        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="{{url('/format/buku')}}" class="btn btn-xs btn-info pull-right">Format Buku</a>
                    <div class="table-responsive">
                        <table class="table table-striped" id="table">
                            ...
                            @foreach($data as $content)
                                <tr>
                                    <td class="py-1">
                                        @if(!isset($content->cover)||!$content->cover)
                                            <img src="{{url('images/buku/'. $content->cover)}}" alt="image"
                                                 style="margin-right: 10px;"/>
                                        @else
                                            <img src="{{url('images/buku/default.png')}}" alt="image"
                                                 style="margin-right: 10px;"/>
                                        @endif
                                        <a href="{{route('buku.show', $content->id)}}">
                                            {{$content->judul}}
                                        </a>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="btn-group dropdown">
                                            ...
                                            <div class="dropdown-menu" x-placement="bottom-start"
                                                ...
                                                <a class="dropdown-item" href="{{route('buku.edit', $content->id)}}">
                                                    Edit </a>
                                                <form action="{{ route('buku.destroy', $content->id) }}" class="pull-left"
                                                      method="post">
                                                    {{ csrf_field() }}
                                                    {{ method_field('delete') }}
